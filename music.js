...
const commands = {
	...
	'reboot': (msg) => {
		if (msg.author.id == tokens.ownerid) process.exit(); //Requires a node module like Forever to work.
	},
'playjm': (msg) => {
const dispatcher = msg.guild.voiceConnection.playStream('/home/ubuntu/morfinabot/sample/JM.mp3');
	}
...
client.login("MzQzODUyNTEzMzA2MzQ1NDcy.DdyI4w.of05NHR-8wKhUFQOIKcmdFtVQ20");